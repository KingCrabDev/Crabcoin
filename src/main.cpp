...
#if defined(NDEBUG)
# error "Crabcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Crabcoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight > 600000) // ~3 Years
    {
        nSubsidy = nCoinAge * 0.1 * 33 / (365 * 33 + 8);
    }
